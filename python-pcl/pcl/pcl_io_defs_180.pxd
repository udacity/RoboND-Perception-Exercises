...
cdef extern from "pcl/io/pcd_io.h" namespace "pcl::io":
    ...
    int loadPCDFile(string file_name, cpp.PointCloud[cpp.PointXYZ] &cloud) nogil except +
    int savePCDFile(string file_name, cpp.PointCloud[cpp.PointXYZ] &cloud, bool binary_mode) nogil except +
    ...
    int loadPCDFile(string file_name, cpp.PointCloud[cpp.PointXYZI] &cloud) nogil except +
    int savePCDFile(string file_name, cpp.PointCloud[cpp.PointXYZI] &cloud, bool binary_mode) nogil except +
    
    # XYZRGB
    int load(string file_name, cpp.PointCloud[cpp.PointXYZRGB] &cloud) nogil except +
    int loadPCDFile(string file_name, cpp.PointCloud[cpp.PointXYZRGB] &cloud) nogil except +
    int savePCDFile(string file_name, cpp.PointCloud[cpp.PointXYZRGB] &cloud, bool binary_mode) nogil except +
    
    # XYZRGBA
    int load(string file_name, cpp.PointCloud[cpp.PointXYZRGBA] &cloud) nogil except +
    int loadPCDFile(string file_name, cpp.PointCloud[cpp.PointXYZRGBA] &cloud) nogil except +
    int savePCDFile(string file_name, cpp.PointCloud[cpp.PointXYZRGBA] &cloud, bool binary_mode) nogil except +
    
    # PointWithViewpoint
    int load(string file_name, cpp.PointCloud[cpp.PointWithViewpoint] &cloud) nogil except +
    int loadPCDFile(string file_name, cpp.PointCloud[cpp.PointWithViewpoint] &cloud) nogil except +
    int savePCDFile(string file_name, cpp.PointCloud[cpp.PointWithViewpoint] &cloud, bool binary_mode) nogil except +
