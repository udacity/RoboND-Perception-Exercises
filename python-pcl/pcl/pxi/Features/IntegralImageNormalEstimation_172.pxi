...
cimport pcl_features_defs_172 as pcl_ftr

from boost_shared_ptr cimport sp_assign

# cdef extern from "minipcl.h":
#     void mpcl_features_defs_NormalEstimationMethod_AVERAGE_3D_GRADIENT(pcl_ftr.IntegralImageNormalEstimation_t ) except +
#     void mpcl_features_defs_NormalEstimationMethod_COVARIANCE_MATRIX(pcl_ftr.IntegralImageNormalEstimation_t ) except +
#     void mpcl_features_defs_NormalEstimationMethod_AVERAGE_DEPTH_CHANGE(pcl_ftr.IntegralImageNormalEstimation_t ) except +
#     void mpcl_features_defs_NormalEstimationMethod_SIMPLE_3D_GRADIENT(pcl_ftr.IntegralImageNormalEstimation_t ) except +
#     void mpcl_features_defs_NormalEstimationMethod_compute(pcl_ftr.IntegralImageNormalEstimation_t, cpp.PointCloud_Normal_t ) except +
...
cdef class IntegralImageNormalEstimation:
    ...
    #    mpcl_features_defs_NormalEstimationMethod_AVERAGE_3D_GRADIENT(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()))

    # def set_NormalEstimation_Method_COVARIANCE_MATRIX (self):
    #    mpcl_features_defs_NormalEstimationMethod_COVARIANCE_MATRIX(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()))

    # def set_NormalEstimation_Method_AVERAGE_DEPTH_CHANGE (self):
    #    mpcl_features_defs_NormalEstimationMethod_AVERAGE_DEPTH_CHANGE(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()))

    # def set_NormalEstimation_Method_SIMPLE_3D_GRADIENT (self):
    #    mpcl_features_defs_NormalEstimationMethod_SIMPLE_3D_GRADIENT(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()))
    ...
    #     mpcl_features_defs_NormalEstimationMethod_compute(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()), normals)
    #     print ('3a')
    #     # Copy?
    ...
    #     # mpcl_features_defs_NormalEstimationMethod_compute(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()), deref(cPointCloudNormal.makeShared().get()))
    #     # mpcl_features_defs_NormalEstimationMethod_compute(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()), cPointCloudNormal.makeShared().get())
    #     # NG : Normal Pointer Nothing?
    #     # mpcl_features_defs_NormalEstimationMethod_compute(<pcl_ftr.IntegralImageNormalEstimation_t> deref(self.thisptr()), deref(cPointCloudNormal))
    #     print ('4')
    #     return normal
